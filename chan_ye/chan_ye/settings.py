...
SPIDER_MODULES = ['chan_ye.spiders']
NEWSPIDER_MODULE = 'chan_ye.spiders'
...
DOWNLOADER_MIDDLEWARES = {
	'chan_ye.middlewares.ProxyMiddleware': 1,
	'chan_ye.middlewares.RetryMiddleware': 110,
	'chan_ye.middlewares.RotateUserAgentMiddleware': 3,
	# 'chan_ye.middlewares.BloomfilterMiddleware': 2,
...
ITEM_PIPELINES = {
	'chan_ye.pipelines.MysqlPipeline': 999,
	# 'chan_ye.pipelines.DuplicatesPipeline': 111,
}
